...
If you’d prefer to start making something, head over to the tutorial [Make a crochet granny square](make-granny-square.md). 
...
To learn more about constructing a granny square, see the tutorial [Make a crochet granny square](make-granny-square.md).
